                ...
                <?php $i = 1; ?>
                  @foreach($data as $value)
                    <tr>
                      ...
                      -->
                      <td> <button class="buy" onclick="callpaytech(this)" data-item-id="88" >Acheter iphone (450000 XOF)
                        </button> </td>
  ...
  <script type="text/javascript">                                  
    function callpaytech(btn){
      (new PayTech({
          ...
          requestTokenUrl : "https://www.senbill.com/mes-factures/locataire/paytech",
          method : "POST",
          headers : {
          "Accept" : "text/html",
