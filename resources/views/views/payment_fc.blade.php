    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Payez votre facture par Free Cash</div>
                ...
                <div class="panel-body">
                  <div class="container">
                    ...
                    <img class="img-responsive pull-right" src="{{ asset('images/free.png') }}">
                    </div>
                    </div>
                  </div>warning
                    <div class="panel-body">
                    ...
                    <div class="row">
                    <div class="col-xs-12">
                    <button class="btn btn-lg btn-block" type="submit" style="background-color:#FE2E2E;color:white">Payez
                      @php
