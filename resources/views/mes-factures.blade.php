                  ...
                  <tbody style="background-color:#fff;color:#455469">
                    @foreach($data as $value)
                      <tr>
                        ...
                        @endif
                        @if($value->status != "paid")
                          <td><button data-toggle="modal" data-target="#pay_bill" class="btn btn-danger btn-xs"> Régler</button> <br /> <span style="font-size:2;font-weight: lighter;color:black;"> avant le {{$value->created_at}} <span></td>
                          <td> n/a </td>
