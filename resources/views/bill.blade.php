...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>Facture du mois de {{$data[0]->month}}</title>
    <style>
    @font-face {
font-family: Junge;
    ...
    <main>
      ...
      <div id="details" class="clearfix">
        <div id="project">
          ...
          <div class="arrow"><div class="inner-arrow">{{ Auth::user()->first_name }} {{ Auth::user()->name }}</div></div>
          <div class="arrow"><div class="inner-arrow">{{ Auth::user()->address }}</div></div>
          <div class="arrow"><div class="inner-arrow">{{ Auth::user()->email }}</div></div>
        </div>
        <div id="company">
