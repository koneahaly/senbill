    ...
    <body class="welcome_elektra">
      <div class="s2sn-wrapper-login-container s2sn-js-login" style="background-image: url(<?php echo e(url('images/stLouis.jpg')); ?>);">
         ...
         <div class="s2sn-wrapper-center s2sn-wrapper-when-footer">
           <img src="<?php echo e(url('images/logo-senbill-halo.png')); ?>" alt="logo-senbill" width="auto" height="100" class="s2sn-logo-elektra">
               ...
               <div class="modal-body">
                <div class="row">
                  ...
                  <div class="col-9">
                    ...
                    <br/>
                    <p class="mb-0">Pour vous connecter en tant que client <strong>prépayé</strong>, utilisez <span class="text-info"><?php echo e($user_cl); ?></span> comme nom d'utilisateur et <span class="text-white bg-dark">demo123</span> comme mot de passe.</p>
