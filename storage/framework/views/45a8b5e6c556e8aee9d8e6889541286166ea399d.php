...
<link rel="stylesheet" href="<?php echo e(url('css/payment_modal.css')); ?>">
...
<div id="app" class="s2sn-wrapper-login-container s2sn-js-login" style="background-image: url(<?php echo e(url('images/white-background/19366_Fotor1.jpg')); ?>);">
  ...
  <div class="s2sn-login-header-desktop-elektra">
      <a class="s2sn-logo-elektra-register" href="<?php echo e($home_directory); ?>">
      ...
      <div class="s2sn-login-header-nav">
       <ul class="s2sn-navbar"  style="margin-left: 300px;">
         <!-- Authentication Links -->
           ...
           <li><a class="s2sn-header-link-elektra elektra-register-button" href="<?php echo e(route('register')); ?>" >S'inscrire</a></li>
        </ul>
      </div>
  </div>
  ...
  <?php else: ?>
      ...
      <div class="s2sn-login-header-desktop-elektra">
        ...
        <?php if( $service == "electricite"): ?>
          ...
          <lottie-player src="<?php echo e(url('images/lottie/light.json')); ?>"  background="transparent"  speed="1" class="space-logo"   loop  autoplay></lottie-player>
        <?php endif; ?>

       <!--  POUR EAU -->
        <?php if( $service == "eau"): ?>
          <p class="custom-space">Espace eau</p>
          <lottie-player src="<?php echo e(url('images/lottie/water.json')); ?>"  background="transparent"  speed="1" class="space-logo"  loop  autoplay></lottie-player>
       <?php endif; ?>
      <!--  POUR TV -->
      <?php if( $service == "tv"): ?>
        <p class="custom-space">Espace Télévision </p>
        <lottie-player src="<?php echo e(url('images/lottie/tv.json')); ?>"  background="transparent"  speed="1" class="space-logo-tv" loop  autoplay></lottie-player>
      <?php endif; ?>

     <!--  POUR MOBILE & Internet -->
     <?php if( $service == "mobile"): ?>
      <p class="custom-space">Espace Mobile & Internet</p>
      <lottie-player src="<?php echo e(url('images/lottie/wifi.json')); ?>"  background="transparent"  speed="1" class="space-logo-internet"  loop  autoplay></lottie-player>
     <?php endif; ?>
    <!--  POUR Locataire -->
    <?php if( $service == "locataire"): ?>
      <p class="custom-space">Espace Locataire</p>
      <lottie-player src="<?php echo e(url('images/lottie/key.json')); ?>"  background="transparent"  speed="1" class="space-logo-locataire"  loop  autoplay></lottie-player>
   <?php endif; ?>
  ...
  <?php if( $service == "sport"): ?>
    ...
    <lottie-player src="<?php echo e(url('images/lottie/7206-run-for-loading.json')); ?>"  background="transparent"  speed="1" class="space-logo-locataire"  loop  autoplay></lottie-player>
  <?php endif; ?>
         ...
         <ul class="s2sn-navbar-elektra">
             ...
             <li class="nav-item item-connected">
               <a class="nav-link <?php echo e($active_4); ?>"  href="../suivi-conso/<?php echo e($service); ?>">
                 <i  class="fa fa-chart-bar fa-2x ">
                 </i> <p>Suivi conso</p>
                </a>
             </li>
               <li class="nav-item item-connected">
                 <a class="nav-link <?php echo e($active_3); ?>"  href="../mes-factures/<?php echo e($service); ?>">
               ...
               <li class="nav-item item-connected">
                 <a class="nav-link <?php echo e($active_2); ?>"  href="../mon-contrat/<?php echo e($service); ?>">
               ...
               <li class="dropdown nav-item item-connected">
                   ...
                   <ul class="dropdown-menu">
                       <li class="dropdown-item" style="text-transform:capitalize">
                         <a href="../infos-personnelles/<?php echo e($service); ?>">
                       ...
                       <li style="padding:0px;text-transform:capitalize" class="dropdown-item">
                         <a  href="../infos-services/<?php echo e($service); ?>">
                           mes services
                         </a>
                       </li>
                      <?php endif; ?>
  ...
  <?php endif; ?>
    ...
    <nav class="navbar navbar-dark s2sn-login-header-mobile-elektra" role="navigation">
        ...
        <span></span>
              ...
              <?php if( $service == "electricite"): ?>
                <p class="custom-space">Espace electricité</p>
                <lottie-player src="<?php echo e(url('images/lottie/light.json')); ?>"  background="transparent"  speed="1" class="space-logo logoEspaceMobile"   loop  autoplay></lottie-player>
              <?php endif; ?>

             <!--  POUR EAU -->
              <?php if( $service == "eau"): ?>
                <p class="custom-space">Espace eau</p>
                <lottie-player src="<?php echo e(url('images/lottie/water.json')); ?>"  background="transparent"  speed="1" class="space-logo logoEspaceMobile"  loop  autoplay></lottie-player>
             <?php endif; ?>
            <!--  POUR TV -->
            <?php if( $service == "tv"): ?>
              <p class="custom-space">Espace Télévision </p>
              <lottie-player src="<?php echo e(url('images/lottie/tv.json')); ?>"  background="transparent"  speed="1" class="space-logo-tv logoEspaceMobile" loop  autoplay></lottie-player>
            <?php endif; ?>

           <!--  POUR MOBILE & Internet -->
           <?php if( $service == "mobile"): ?>
            <p class="custom-space">Espace Mobile & Internet</p>
            <lottie-player src="<?php echo e(url('images/lottie/wifi.json')); ?>"  background="transparent"  speed="1" class="space-logo-internet logoEspaceMobile"  loop  autoplay></lottie-player>
           <?php endif; ?>
          <!--  POUR Locataire -->
          <?php if( $service == "locataire"): ?>
            <p class="custom-space">Espace Locataire</p>
            <lottie-player src="<?php echo e(url('images/lottie/key.json')); ?>"  background="transparent"  speed="1" class="space-logo-locataire logoEspaceMobile"  loop  autoplay></lottie-player>
         <?php endif; ?>
         <?php if( $service == "scolarite"): ?>
           <p class="custom-space">Espace Scolarité</p>
         ...
         <?php if( $service == "sport"): ?>
           <p class="custom-space">Espace Sport</p>
           <lottie-player src="<?php echo e(url('images/lottie/7206-run-for-loading.json')); ?>"  background="transparent"  speed="1" class="space-logo-locataire logoEspaceMobile"  loop  autoplay></lottie-player>
         <?php endif; ?>
              <?php endif; ?>
  ...
  <nav class="navbar navbarMobileElek navbar-expand-md navbar-dark bg-dark fixed-bottom">
    <ul id="nav-list" class="mobile-nav_list-elektra">
      ...
      <?php else: ?>
      <li class="mobile-nav-elektra-item">
          <a href="../suivi-conso/<?php echo e($service); ?>" class="mobile-nav-elektra-link mobile-nav-elektra-link--active">
              <i class="fa fa-envelope-open-text mobile-nav-elektra-icon"></i>
              Suivi conso
          </a>
      </li>
      <li class="mobile-nav-elektra-item">
          <a href="../mes-factures/<?php echo e($service); ?>" class="mobile-nav-elektra-link ">
      ...
      <li class="mobile-nav-elektra-item">
          <a href="../mon-contrat/<?php echo e($service); ?>" class="mobile-nav-elektra-link ">
              <i class="fa fa-building mobile-nav-elektra-icon"></i>
              Contrat
          </a>
      </li>
      <li class="mobile-nav-elektra-item">
          <a href="../infos-personnelles/<?php echo e($service); ?>" class="mobile-nav-elektra-link ">
  ...
  <div id="mobile-nav-overlay" class="mobile-nav-elektra-overlay" >
        ...
        <ul class="mobile-nav-elektra-menu-popup">
            <li class="mobile-nav-elektra-item mobile-nav-elektra-item--popup">
                <a class="mobile-nav-elektra-inherit-color" href="../infos-services/<?php echo e($service); ?>">Mes services</a>
            </li>
