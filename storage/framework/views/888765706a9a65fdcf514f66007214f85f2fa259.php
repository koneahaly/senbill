        ...
        <div class="col-lg-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body" style="text-align:center">
              ...
              <strong style="margin-top:10px;text-transform: capitalize;"><?php echo e(Auth::user()->first_name.' '.Auth::user()->name); ?></strong>
                    ...
                    <div class="card-body-contract">
                      <div class="row" style="margin-left: 1%;">
                        <div class="col-md-8">
                          ...
                          <span class="h4 font-weight-bold mb-0"><?php echo e($wording_offer); ?></span>
                        </div>
                        <div class="col-auto">
                          <div>
                    ...
                    <div class="card-body-contract">
                      <div class="row" style="margin-left: 1%;">
                        <div class="col-md-8">
                          ...
                          <span class="h4 font-weight-bold mb-0"><?php echo e(($wording_offer == 'Inconnue') ? 'Inactif' : 'Actif'); ?></span>
                        </div>
                        <div class="col-auto">
                          <div>
                    ...
                    <div class="card-body-contract">
                      <div class="row" style="margin-left: 1%;">
                        <div class="col-md-8">
                          ...
                          <span class="h4 font-weight-bold mb-0"><?php echo substr(Auth::user()->created_at, 0, 10); ?></span>
                        </div>
                        <div class="col-auto">
                          <div>
                    ...
                    <div class="card-body-contract">
                      <div class="row" style="margin-left: 1%;">
                        <div class="col-md-8">
                          ...
                          <span class="h4 font-weight-bold mb-0"><?php echo e(Auth::user()->customerId); ?></span>
                        </div>
                        <div class="col-auto">
                          <div>
             ...
             <div class="panel panel-default contractContentMobile" id= "contract-panel">
                 ...
                 <div class="panel-body contractContent">
                   ...
                   <div class="col-md-6" style="margin-bottom:20px;">
                     <p>OFFRE</p>
                     <span class="recapData"><strong><?php echo e($wording_offer); ?></strong></span>
                   </div>
                   ...
                   <div class="row  text-center" style="margin-bottom:20px;">
                     <div class="col-md-6" style="margin-bottom:20px;">
                       <p>STATUT</p>
                       <span class="recapData"><strong> <?php echo e(($wording_offer == 'Inconnue') ? 'INACTIF' : 'ACTIF'); ?> </strong></span>
                     </div>

                     <div class="col-md-6" style="margin-bottom:20px;">
                       <p>DATE DE D&Eacute;BUT DU CONTRAT</p>
                       <span class="recapData"><strong> <?php echo e(Auth::user()->created_at); ?> </strong></span>
                     </div>
                    </div>
                   ...
                   <div class="col-md-6 col-md-offset-0" style="margin-bottom:20px;">
                     ...
                     <span class="recapData"><strong><?php echo e(Auth::user()->customerId); ?></strong></span>
                   </div>
                   <?php if($_SESSION['current_service'] == 'electricite'): ?>
                     <div class="col-md-6 col-md-offset-0" style="margin-bottom:20px;">
                   ...
                   <?php if($_SESSION['current_service'] == 'eau'): ?>
                     <div class="col-md-6 col-md-offset-0" style="margin-bottom:20px;">
                       <p>OFFRE</p>
                   ...
                   <?php if($_SESSION['current_service'] == 'tv'): ?>
                     <div class="col-md-6 col-md-offset-0" style="margin-bottom:20px;">
                       <p>OFFRE</p>
                   ...
                   <?php if($_SESSION['current_service'] == 'mobile'): ?>
                     <div class="col-md-6 col-md-offset-0" style="margin-bottom:20px;">
                       <p>OFFRE</p>
                   ...
                   <?php if($_SESSION['current_service'] == 'locataire'): ?>
                     <div class="col-md-6 col-md-offset-0" style="margin-bottom:20px;">
                       <p>OFFRE</p>
                   ...
                   <div class="col-md-12" style="margin-bottom:40px;" >
                     ...
                     <span>
                       Si vous souhaitez parrainer un(e) proche, vous avez la possibilité
                        ...
                        pourra souscrire son contrat <a href="127.0.0.1/parrainage/<?php echo e(Auth::user()->customerId); ?>">ici </a>.
