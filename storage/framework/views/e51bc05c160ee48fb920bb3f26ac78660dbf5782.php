...
<html lang="<?php echo e(app()->getLocale()); ?>">
    <head>
      ...
      <script src='https://www.google.com/recaptcha/api.js'></script>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo e(url('css/elektra_bis.css')); ?>">
        <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet" integrity="sha384-wvfXpqpZZVQGK6TAh5PVlGOfQNHSoD2xbE+QkPxCAFlNEevoEH3Sl0sibVcOQVnN" crossorigin="anonymous">

    </head>
    <body class="welcome_elektra">
      <div class="s2sn-wrapper-login-container s2sn-js-login" style="background-image: url(<?php echo e(url('images/stLouis.jpg')); ?>);">
      	 <!-- HEADER START -->
         <div class="s2sn-login-header-desktop">
             <a class="s2sn-logo-elektra" href=".">
                 <img src="<?php echo e(env('S3_URL')); ?>/<?php echo e(env('AWS_BUCKET')); ?>/logo-s2sn.png" alt="logo-senbill" width="162" height="auto" class="s2sn-img-normal">
             	   <img src="<?php echo e(env('S3_URL')); ?>/<?php echo e(env('AWS_BUCKET')); ?>/logo-s2sn-mediumsmall.png" alt="logo-senbill" width="162" height="auto" class="s2sn-img-retina">
             </a>
          ...
          <ul class="s2sn-navbar">
              ...
              <li><a class="s2sn-header-link" href="<?php echo e(route('what')); ?>">LA PLATEFORME SENBILL &nbsp </a></li>
              <li><a class="s2sn-header-link" href="<?php echo e(route('register')); ?>">S'INSCRIRE</a></li>
          </ul>
      </div>
         </div>
         <nav class="navbar navbar-dark s2sn-login-header-mobile">
             ...
             <div class="collapse navbar-collapse" id="navbarNav">
                 <ul class="navbar-nav">
                     ...
                     <li class="nav-item"><a class="nav-link" href="<?php echo e(route('what')); ?>">LA PLATEFORME SENBILL</a></li>
                     <li class="nav-item"><a class="nav-link" href="<?php echo e(route('register')); ?>" >S'INSCRIRE</a></li>
         ...
         <div class="s2sn-wrapper-center s2sn-wrapper-when-footer">
           <img src="<?php echo e(url('images/logo-senbill-halo.png')); ?>" alt="logo-elektra" width="auto" height="100" class="s2sn-logo-elektra">
         ...
         <form action="<?php echo e(route('login')); ?>" name="loginForm" id="loginForm" method="post" autocomplete="off">
           <?php echo e(csrf_field()); ?>
            ...
            <?php endif; ?>
            <div class="s2sn-input-group input-group form-slider-step form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>" id="form-step-1">
             <input type="text" name="email" id="PIN" value="<?php echo e(old('email')); ?>" class="form-control" placeholder="Veuillez saisir votre login ou email" aria-label="Veuillez saisir votre login ou email" required>
            ...
            <div>
              <a style="color:white;font-weight:bold;" class="btn btn-link" href="<?php echo e(route('password.request')); ?>">
                  Mot de passe oublié?
              </a>
            </div>
           </div>
               ...
               <div class="modal-body">
                <div class="row">
                  ...
                  <div class="col-9">
                    ...
                    <p class="mb-0">Pour vous connecter en tant que client <strong>classique(postpayé)</strong>, utilisez <span class="text-info"><?php echo e($user_wy); ?></span> comme nom d'utilisateur et <span class="text-white bg-dark">demo123</span> comme mot de passe.</p>
                    <br/>
                  </div>
                </div>
               </div>
