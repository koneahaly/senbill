...
<html lang="<?php echo e(app()->getLocale()); ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(url('css/style_mobirise.css')); ?>">
        <link rel="preload" as="style" href="<?php echo e(url('css/mbr-additional.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(url('css/mbr-additional.css')); ?>" type="text/css">
